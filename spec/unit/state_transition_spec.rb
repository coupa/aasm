...
describe AASMLegacy::SupportingClasses::StateTransition do
  it 'should set from, to, and opts attr readers' do
    opts = {:from => 'foo', :to => 'bar', :guard => 'g'}
    st = AASMLegacy::SupportingClasses::StateTransition.new(opts)
...
describe AASMLegacy::SupportingClasses::StateTransition, '- when performing guard checks' do
