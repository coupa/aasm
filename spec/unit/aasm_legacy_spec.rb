...
describe AASMLegacy, '- class level definitions' do
...
describe AASMLegacy, '- subclassing' do
...
describe AASMLegacy, '- aasm_states_for_select' do
...
describe AASMLegacy, '- instance level definitions' do
  before(:each) do
    @foo = Foo.new
  end
...
describe AASMLegacy, '- initial states' do
  before(:each) do
    @foo = Foo.new
    @bar = Bar.new
  end
...
describe AASMLegacy, '- event firing with persistence' do
...
describe AASMLegacy, '- event firing without persistence' do
  it 'should fire the Event' do
    foo = Foo.new
...
describe AASMLegacy, '- persistence' do
...
describe AASMLegacy, '- getting events for a state' do
...
describe AASMLegacy, '- event callbacks' do
...
describe AASMLegacy, '- state actions' do
